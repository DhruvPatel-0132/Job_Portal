...
const dummyPosts = [
  ...
  },
  {
    ...
    timeAgo: '5h',
    content: 'We are looking for talented frontend engineers to join our growing team. If you are passionate about building great user experiences, let\'s connect!',
  ...
  },
  {
    ...
    timeAgo: '1d',
    content: 'Design systems are more than just component libraries. They are a shared language between design and engineering teams. Here are some thoughts on how to build them effectively.',
    image: null,
    likesCount: 89,
    commentsCount: 12,
    sharesCount: 5,
  },
  {
    ...
    timeAgo: '2d',
    content: 'The latest advancements in large language models are opening up new possibilities for AI applications. I\'ve been experimenting with some new frameworks and the results are promising.',
    image: '/post-image.svg',
    likesCount: 567,
    commentsCount: 82,
    sharesCount: 45,
  },
  {
    ...
    timeAgo: '3d',
    content: 'Performance optimization in single-page applications is a continuous process. Remember to measure before you optimize! #webperformance #javascript',
    image: null,
    likesCount: 210,
    commentsCount: 24,
    sharesCount: 10,
    ...
    <div className="flex flex-col w-full">
      ...
      <div className="bg-white rounded-lg border border-gray-200 mb-4 p-4 shadow-sm">
        ...
        <div className="flex justify-between mt-3 px-2 sm:px-6">
          ...
          <button className="flex items-center space-x-2 text-gray-500 hover:bg-gray-100 p-2 rounded-md transition-colors">
            <svg className="w-5 h-5 text-red-400" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clipRule="evenodd" /></svg>
